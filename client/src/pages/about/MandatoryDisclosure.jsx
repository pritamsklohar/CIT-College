      ...
      <div className="container mx-auto px-4 py-20">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-2/3">
             <h2 className="text-3xl font-black text-primary mb-8 flex items-center gap-2 uppercase">
                <span className="w-1.5 h-8 bg-accent inline-block"></span> Statutory Compliance
             </h2>
             <div 
               className="rich-text-content prose prose-lg max-w-none text-gray-700 leading-relaxed mb-12"
             ...
             <div className="grid md:grid-cols-2 gap-6">
                {documents.map((doc, i) => (
                  <a 
                    ...
                    href={doc.link} 
                    target="_blank"
                    className="flex items-center justify-between bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:border-accent hover:bg-white hover:shadow-xl transition group"
                  >
                     <div className="flex items-center gap-4">
                        <div className="bg-primary bg-opacity-10 p-3 rounded-xl text-primary group-hover:bg-accent group-hover:text-white transition"><FaFilePdf /></div>
                        <span className="font-bold text-gray-700 text-sm">{doc.name}</span>
                     </div>
