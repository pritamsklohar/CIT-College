  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="py-12 bg-primary relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 grid grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {stats.map((s, i) => (
              <motion.div 
              ...
              >
                 <div className="text-4xl text-accent mb-3 flex justify-center">{s.icon}</div>
                 <div className="text-3xl md:text-5xl font-black mb-2">{s.value}</div>
                 <div className="text-xs md:text-sm font-bold uppercase tracking-widest opacity-80">{s.label}</div>
              </motion.div>
            ))}
         </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            <p className="text-gray-600 font-semibold leading-relaxed text-lg mb-6 text-justify">
            ...
            <div className="bg-orange-50 p-6 rounded-2xl border-l-4 border-accent">
          ...
          <div>
             <div className="bg-primary p-10 rounded-3xl text-white shadow-2xl h-full flex flex-col justify-center relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-125 transition duration-700">
                  <FaBullseye className="text-9xl" />
                </div>
                <h3 className="text-3xl font-black mb-6 flex items-center gap-3 relative z-10 text-accent">
                  VISION & MISSION
                </h3>
                <p className="leading-relaxed opacity-90 relative z-10 text-justify mb-4">
                ...
                <p className="leading-relaxed opacity-90 relative z-10 text-justify">
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {objectives.map((obj, i) => (
                <li key={i} className="flex items-start gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-orange-50 transition border border-transparent hover:border-accent group">
                  <FaCheckCircle className="text-accent text-xl shrink-0 mt-1" />
                  <span className="text-gray-700 font-medium group-hover:text-primary transition">{obj}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {studentTraining.map((item, i) => (
                <li key={i} className="flex items-start gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-orange-50 transition border border-transparent hover:border-accent group">
                  <FaLightbulb className="text-accent text-xl shrink-0 mt-1" />
                  <span className="text-gray-700 font-medium group-hover:text-primary transition">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {trainingActivities.map((item, i) => (
                <li key={i} className="flex items-start gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-orange-50 transition border border-transparent hover:border-accent group">
                  <FaChartLine className="text-accent text-xl shrink-0 mt-1" />
                  <span className="text-gray-700 font-medium group-hover:text-primary transition">{item}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-gray-600 mb-6 font-medium italic">CIT provides all the necessary facilities to recruiters for their placement drives at the campus:</p>
              <ul className="space-y-4">
                {facilities.map((item, i) => (
                  <li key={i} className="flex items-start gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-orange-50 transition border border-transparent hover:border-accent group">
                    <FaBuilding className="text-accent text-xl shrink-0 mt-1" />
                    <span className="text-gray-700 font-medium group-hover:text-primary transition">{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <div className="bg-gray-100 p-8 rounded-3xl border-l-4 border-primary">
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1">
             <div className="bg-primary p-10 rounded-3xl text-white shadow-2xl sticky top-24">
                <h4 className="text-2xl font-black mb-8 border-b-2 border-accent pb-4 inline-block uppercase flex items-center gap-3">
                  <FaHandshake className="text-accent" /> Get In Touch
                </h4>
                
                <div className="space-y-8">
                   <div>
                      <p className="text-sm font-bold text-accent uppercase tracking-widest mb-1">Head – T&P</p>
                      <p className="text-2xl font-black">Mrs. Anu Badola</p>
                   </div>
                   
                   <div className="flex items-center gap-4 group">
                      <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-accent transition">
                         <FaPhoneAlt className="text-xl" />
                      </div>
                      <div>
                         <p className="text-xs font-bold opacity-70 uppercase tracking-wider mb-1">Contact</p>
                         <a href="tel:+919166266888" className="font-bold text-lg hover:text-accent transition">+91-9166266888</a>
                      </div>
                   </div>

                   <div className="flex items-center gap-4 group">
                      <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-accent transition shrink-0">
                         <FaEnvelope className="text-xl" />
                      </div>
                      <div className="break-all">
                         <p className="text-xs font-bold opacity-70 uppercase tracking-wider mb-1">Email</p>
                         <a href="mailto:Placements@citabu.ac.in" className="font-bold block hover:text-accent transition">Placements@citabu.ac.in</a>
                         <a href="mailto:anubadola@citabu.ac.in" className="font-bold block hover:text-accent transition">anubadola@citabu.ac.in</a>
                      </div>
                   </div>
                </div>
             </div>
          ...
          <div className="lg:col-span-2">
             <h4 className="text-3xl font-black text-primary mb-8 border-b-2 border-accent pb-2 inline-block uppercase">Our Top Recruiters</h4>
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {recruiters.map((r, i) => (
                  <div key={i} className="aspect-square bg-gray-50 p-6 rounded-2xl border border-gray-100 flex items-center justify-center hover:shadow-xl hover:border-accent transition group bg-white">
