...
const PageBanner = ({ title, breadcrumb }) => {
  ...
  return (
    <div ref={container} className="bg-primary py-24 relative overflow-hidden text-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
         <h1 className="banner-anim text-4xl md:text-6xl font-black text-white mb-4 uppercase tracking-wider">{title}</h1>
         <div className="banner-anim text-accent font-bold tracking-widest text-sm uppercase">
